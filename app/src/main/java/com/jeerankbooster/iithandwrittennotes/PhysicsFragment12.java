...
public class PhysicsFragment12 extends Fragment {
    ...
    public static PhysicsFragment12 newInstance()
    {
        PhysicsFragment12 categoryFragment = new PhysicsFragment12();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categories = database.getReference("Phy12");
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_physics12,container,false);
    ...
    private void loadCategories() {
        adapter = new FirebaseRecyclerAdapter<Category, CategoryViewHolder>(
            ...
            protected void populateViewHolder(final CategoryViewHolder viewHolder, final Category model, int position) {
                ...
                Picasso.with(getActivity()).load(R.drawable.phy).into(viewHolder.category_image, new Callback() {
                    @Override
                    ...
                    @Override
                    public void onError() {
                        Picasso.with(getActivity()).load(R.drawable.phy).into(viewHolder.category_image);
                    }
                });
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        {
                            Intent startGame =  new Intent(getActivity(),Start12.class);
