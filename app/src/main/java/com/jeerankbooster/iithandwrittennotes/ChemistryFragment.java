...
public class ChemistryFragment extends Fragment {
    ...
    public static ChemistryFragment newInstance()
    {
        ChemistryFragment categoryFragment = new ChemistryFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categories = database.getReference("Che");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_chemistry,container,false);
    ...
    private void loadCategories() {
        adapter = new FirebaseRecyclerAdapter<Category, CategoryViewHolder>(
            ...
            protected void populateViewHolder(final CategoryViewHolder viewHolder, final Category model, int position) {
                ...
                Picasso.with(getActivity()).load(R.drawable.che).networkPolicy(NetworkPolicy.OFFLINE).into(viewHolder.category_image, new Callback() {
                    @Override
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        {
                            Intent startGame =  new Intent(getActivity(),Start3.class);
