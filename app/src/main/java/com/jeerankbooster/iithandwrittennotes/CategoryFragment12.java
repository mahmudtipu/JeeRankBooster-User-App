...
public class CategoryFragment12 extends Fragment {
    ...
    {
        CategoryFragment12 categoryFragment = new CategoryFragment12();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categories = database.getReference("Math12");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_category12,container,false);
    ...
    private void loadCategories() {
        adapter = new FirebaseRecyclerAdapter<Category, CategoryViewHolder>(
            ...
            protected void populateViewHolder(final CategoryViewHolder viewHolder, final Category model, int position) {
                ...
                Picasso.with(getActivity()).load(R.drawable.math).into(viewHolder.category_image, new Callback() {
                    @Override
                    ...
                    @Override
                    public void onError() {
                        Picasso.with(getActivity()).load(R.drawable.math).into(viewHolder.category_image);
                    }
                });
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        {
                            Intent startGame =  new Intent(getActivity(),Start11.class);
