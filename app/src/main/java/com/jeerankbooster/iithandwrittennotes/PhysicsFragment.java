...
public class PhysicsFragment extends Fragment {
    ...
    public static PhysicsFragment newInstance()
    {
        PhysicsFragment categoryFragment = new PhysicsFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        categories = database.getReference("Phy");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_physics,container,false);
    ...
    private void loadCategories() {
        adapter = new FirebaseRecyclerAdapter<Category, CategoryViewHolder>(
            ...
            protected void populateViewHolder(final CategoryViewHolder viewHolder, final Category model, int position) {
                ...
                Picasso.with(getActivity()).load(R.drawable.phy).networkPolicy(NetworkPolicy.OFFLINE).into(viewHolder.category_image, new Callback() {
                    @Override
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        {
                            Intent startGame =  new Intent(getActivity(),Start2.class);
